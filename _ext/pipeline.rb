...
Awestruct::Extensions::Pipeline.new do
  ...
  transformer Awestruct::Extensions::Gsub.new(
    /\<!--\s*m1\s*--\>\s*/, 
    "<span class='milestone'><a href='/documentation/1.0roadmap/#milestone_1' title='Support for this feature was introduced in Milestone 1'>Milestone 1</a></span>")
  transformer Awestruct::Extensions::Gsub.new(
    /\<!--\s*m2\s*--\>\s*/, 
    "<span class='milestone future'><a href='/documentation/1.0/roadmap/#milestone_2' title='Support for this feature will be introduced in Milestone 2'>Milestone 2</a></span>")
  transformer Awestruct::Extensions::Gsub.new(
    /\<!--\s*m3\s*--\>\s*/, 
