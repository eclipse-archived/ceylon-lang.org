...
- experimental support for __type functions__ (higher-order
  and higher-rank polymorphism) and references to generic
  functions.
...
is freely available from [GitHub][git]. Information about 
Ceylon's open source licenses is available [here][license];
