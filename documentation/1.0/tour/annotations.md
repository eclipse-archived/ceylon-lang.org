...
[`ConstrainedAnnotation`](#{site.urls.apidoc_1_0}/ConstrainedAnnotation.type.html).
...
* If an annotation type is a subtype of 
  [`OptionalAnnotation`](#{site.urls.apidoc_1_0}/OptionalAnnotation.type.html), 
...
[`annotations()`](#{site.urls.apidoc_1_0}/meta/index.html#annotations) 
...
[API documentation](#{site.urls.apidoc_1_0}/meta/index.html).
