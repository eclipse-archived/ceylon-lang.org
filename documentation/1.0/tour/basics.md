...
[`String`](#{site.urls.apidoc_1_0}/String.type.html)
class has an attribute called 
[`normalized`](#{site.urls.apidoc_1_0}/String.type.html#normalized). 
...
invoke the 
[`string`](#{site.urls.apidoc_1_0}/Object.type.html#string) 
...
That's easy to answer: `null` is a [`Null`](#{site.urls.apidoc_1_0}/Null.type.html).
...
and [`Float`](#{site.urls.apidoc_1_0}/Float.type.html),
