...
[`Category`](#{site.urls.apidoc_1_1}/Category.type.html) interface

### Type

The result type of the `in` operator is [`Boolean`](#{site.urls.apidoc_1_1}/Boolean.type.html).

## See also

* API documentation for [`Category`](#{site.urls.apidoc_1_1}/Category.type.html)
