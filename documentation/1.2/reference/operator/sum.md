...
[`Summable`](#{site.urls.apidoc_1_2}/Summable.type.html) interface.
...
For [`String`](#{site.urls.apidoc_1_2}/String.type.html), `+` performs concatenation.


## See also

* API documentation for [`Summable`](#{site.urls.apidoc_1_2}/Summable.type.html)
