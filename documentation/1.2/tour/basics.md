...
[`normalized`](#{site.urls.apidoc_1_2}/String.type.html#normalized). 
...
That's easy to answer: `null` is a [`Null`](#{site.urls.apidoc_1_2}/Null.type.html).
...
and [`Float`](#{site.urls.apidoc_1_2}/Float.type.html),
