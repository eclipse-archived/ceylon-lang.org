...
[`string`](#{site.urls.apidoc_1_2}/Object.type.html#string). 
...
[`equals()`](#{site.urls.apidoc_1_2}/Identifiable.type.html#equals) 
and [`hash`](#{site.urls.apidoc_1_2}/Identifiable.type.html#hash).
...
members (i.e. members that don't specify an implementation. However, in this
case, the required annotation is `formal`. The reason for having two different 
