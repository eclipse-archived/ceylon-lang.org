...
[`Class`](#{site.urls.apidoc_1_3}/metamodel/Class.type.html) class and 
[`Type`](#{site.urls.apidoc_1_3}/metamodel/Type.type.html) interface.

### Type

The result type of the `entends` operator is [`Boolean`](#{site.urls.apidoc_1_3}/Boolean.type.html).

## See also

* API documentation for [`Class`] _doc coming soon at_ (#{site.urls.apidoc_1_3}/metamodel/Class.type.html)
