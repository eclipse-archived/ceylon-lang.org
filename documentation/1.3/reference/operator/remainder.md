...
[`Integral`](#{site.urls.apidoc_1_3}/Integral.type.html) interface. 
...
For the built-in numeric type [`Integer`](#{site.urls.apidoc_1_3}/Integer.type.html), 
...
* API documentation for [`Integral`](#{site.urls.apidoc_1_3}/Integral.type.html)
