...
[`OptionalAnnotation`](#{site.urls.apidoc_1_3}/OptionalAnnotation.type.html) or 
...
* A subtype of [`Declaration`](#{site.urls.apidoc_1_3}/meta/declaration/Declaration.type.html)
...
* `Annotation` has a subclass, [`ConstrainedAnnotation`](#{site.urls.apidoc_1_3}/metamodel/ConstrainedAnnotation.type.html),
  which allows more fine-grained control over where and how the annotation may be used. 
  Its enumerated subclasses are:
    * [`OptionalAnnotation`](#{site.urls.apidoc_1_3}/metamodel/OptionalAnnotation.type.html) 
      for annotations which occur at most once on a given program element, and
    * [`SequencedAnnotation`](#{site.urls.apidoc_1_3}/metamodel/SequencedAnnotation.type.html)
