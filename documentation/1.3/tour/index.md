...
where `ceylon-1.3.3` is the path to your Ceylon install directory. 
...
<!-- lang: bash -->
    ceylon-1.3.3/bin/ceylon compile
...
<!-- lang: bash -->
    ceylon-1.3.3/bin/ceylon compile source/hello.ceylon

Or, alternatively, the name of the _module_ you wish to 
compile:

<!-- lang: bash -->
    ceylon-1.3.3/bin/ceylon compile default
...
<!-- lang: bash -->
    ceylon-1.3.3/bin/ceylon help compile

Or:

<!-- lang: bash -->
    ceylon-1.3.3/bin/ceylon help run
...
<!-- lang: bash -->
    ceylon-1.3.3/bin/ceylon fat-jar --run=hello default
