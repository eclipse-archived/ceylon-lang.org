...
To include a directory containing web resources like HTML, image,
and JavaScript files in an archive generated by `ceylon war` or
`ceylon swarm`, use ` --resource-root` or `-R`, for example:
